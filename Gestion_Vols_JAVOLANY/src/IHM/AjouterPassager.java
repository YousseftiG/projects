...
public class AjouterPassager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ajouter un Passager");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(210, 30, 380, 130);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(130, 220, 200, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Nom :");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(50, 220, 70, 30);
        ...
        jLabel9.setBounds(440, 220, 70, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String query1 = "INSERT INTO passager (nomPassager,prenomPassager) VALUES ('"+jTextField1.getText()+"','"+jTextField2.getText()+"');"; 
    ...
    jTextField2.setText("");
            ...
            JOptionPane.showMessageDialog(rootPane, "Le passager n'a pas été Ajouté");
              e.printStackTrace();
            }
        JOptionPane.showMessageDialog(rootPane, "Le passager a été bien Ajouté");
